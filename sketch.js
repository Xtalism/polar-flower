...
function setup () {
    canvas = createCanvas(850, 850, WEBGL);
    canvas.class("canvas");
    ...
    pSharpSlider = createSlider(0.0, 10, 0.4, 0.1);
    ...
    curvatureSlider1 = createSlider(0.0, 4.0, 0.6, 0.1);
    ...
    bumpSlider = createSlider(0.0, 5.0, 3.5, 0.5);
    bumpSlider.class("Slider");

    bumpNum = createDiv();
    bumpNum.class("valueDisplay");
    bumpNumSlider = createSlider(0.0, 20, 4, 1);
...
function draw() {
    ...
    bumpNum.html("Bumpiness: " + bumpNumSlider.value());
